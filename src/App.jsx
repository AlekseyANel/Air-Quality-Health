...
import './App.scss';
//импорт компонента Heroblock
import HeroBlock from './components/HeroBlock/HeroBlock';
//импорт картинок-лого Heroblocka
...
function App() {
  ...
  //массив логотипов
const partnersLogo = [shidLogo, ITNLogo, gcLogo];

  //массив из объектов отв. за ссылки
const navLinks = [
...
const sectors = [
  ...
  return (
    ...
    <SectorsList title="Политика по уменьшению загрязнений"
		   ...
		   items={sectors}/>
    <Footer partners={partnersLogo} links ={navLinks}/>
